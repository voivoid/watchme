...
namespace watch_me
{
	...
	void WindowImpl::init_d3d()
	{
		...
		const auto device_created = get_d3d()->CreateDevice(D3DADAPTER_DEFAULT, D3DDEVTYPE_HAL, m_hWnd, D3DCREATE_HARDWARE_VERTEXPROCESSING, &d3d_pp, &d3d_device);
	...
	BOOL WindowImpl::ImGuiMsgHandler::ProcessWindowMessage(const HWND wnd, const UINT msg, const WPARAM wparam, const LPARAM lparam, LRESULT& result, const DWORD /*msg_map*/)
	{
